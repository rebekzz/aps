...
$jscomp.polyfill("Array.from", function (b) {
  return b ? b : function (b, d, q) {
    ...
    if ("function" == typeof m) {
      b = m.call(b);
      for (var r = 0; !(m = b.next()).done;) h.push(d.call(q, m.value, r++))
    } else
...
(function () {
  ...
  function r(a) {
    ...
    (function e() {
      ...
      1 < (g += .1) || (a.style.opacity = g, requestAnimationFrame(e))
    })()
  }
          ...
          if (k && (/youtu\.?be/g.test(k[3]) || /vimeo/g.test(k[3])))
            if (k && /youtu\.?be/g.test(k[3])) {
              ...
              d.onload = function () {
                ...
                } else g.style.backgroundImage = 'url("' + d.src + '")', g.style.display = "block";
        ...
        var a = function () {
            ...
            g.forEach(function (k) {
              var g = k.offsetHeight,
                d = e(k);
              (d + g >= a && d - 50 <= c || b(k)) && k.classList.contains("hidden") && (k.classList.remove("hidden"), k.classList.add("animate__fadeIn"), k.classList.add("animate__delay-1s"), k.addEventListener("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",
                function () {
      ...
      var a = function (a) {
        ...
        b = function (b) {
          ...
          l.addEventListener("click", function (b) {
            "VIDEO" !== b.target.tagName && (e ? (-1 !== e.indexOf("youtu") && c.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', "*"), -1 !== e.indexOf("vimeo") && d.pause()) : (b = c.parentNode.querySelector("video")) && b.pause && b.pause(), l.style.display = "none", l.removeEventListener("click", a), h.style.zIndex = "0")
          })
        };
